...
void calculate (double A[N][N], double B[N], double *X)
{
    ...
    double diff; // between two iterations
...
int main() {
    ...
    if (isConvergent(A)) {
      ...
      std::cerr << "The following matrix is not diagonally dominant." << std::endl;
      print(A);
      std::cerr << "The method has failed a convergence condition" << std::endl;
    }
